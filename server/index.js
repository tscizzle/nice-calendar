...
const DAY_sec = 86400;
const days100_sec = 100 * DAY_sec;
const days100_ms = days100_sec * 1000;
const redisStore = new RedisStore({ client: redisClient, ttl: days100_sec });
const sessionMiddleware = expressSession({
  cookie: { maxAge: days100_ms },
